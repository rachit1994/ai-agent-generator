...
from sde_modes.modes.phased_pipeline.decompose import flatten_plan, fallback_single_todo_plan
...
def test_run_phased_pipeline_runs_guarded_per_todo(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "sde_modes.modes.phased_pipeline.pipeline.run_decompose_phase",
        _fake_decompose,
    )
    monkeypatch.setattr(
        "sde_modes.modes.phased_pipeline.pipeline.run_guarded_pipeline",
        _fake_guarded,
    )
