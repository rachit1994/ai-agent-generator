# Folder: `src/learning_evolution_engine/causal_closure_contract`

## Why this folder exists
This folder groups code and artifacts for `causal_closure_contract` within the repository architecture.
