# Folder: `src/capability_model/scoring_confidence_decay`

## Why this folder exists
This folder groups code and artifacts for `scoring_confidence_decay` within the repository architecture.
