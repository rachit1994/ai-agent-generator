# Folder: `src/service_boundaries/memory_poisoning_sentinel`

## Why this folder exists
This folder groups code and artifacts for `memory_poisoning_sentinel` within the repository architecture.
