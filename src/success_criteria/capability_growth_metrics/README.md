# Folder: `src/success_criteria/capability_growth_metrics`

## Why this folder exists
This folder groups code and artifacts for `capability_growth_metrics` within the repository architecture.
