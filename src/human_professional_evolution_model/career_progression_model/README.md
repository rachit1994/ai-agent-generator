# Folder: `src/human_professional_evolution_model/career_progression_model`

## Why this folder exists
This folder groups code and artifacts for `career_progression_model` within the repository architecture.
