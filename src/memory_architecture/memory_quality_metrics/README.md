# Folder: `src/memory_architecture/memory_quality_metrics`

## Why this folder exists
This folder groups code and artifacts for `memory_quality_metrics` within the repository architecture.
