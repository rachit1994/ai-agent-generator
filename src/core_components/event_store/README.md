# Folder: `src/core_components/event_store`

## Why this folder exists
This folder groups code and artifacts for `event_store` within the repository architecture.

## What is present
- `contracts.py`: Contract/validation for `event_store/component_runtime.json`.
- `runtime.py`: Deterministic event-store component runtime derivation.
