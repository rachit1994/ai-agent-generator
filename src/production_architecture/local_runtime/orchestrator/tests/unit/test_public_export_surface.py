...
Baseline for ``sde_modes`` wiring: public ``def`` entrypoints on ``modes/{baseline,guarded,phased}``, ``guarded_pipeline/{pipeline,verify_core}``, ``phased_pipeline/{pipeline,decompose}`` under ``workflow_pipelines.strategy_overlay.execution_modes``.
...
_LIBS_MIGRATED_PUBLIC_NAMES: Final = (
    (
        ...
        ("outputs_base", "create_run_id", "now_iso", "ms_to_iso"),
    ),
    (
    ...
    ("core_components.orchestrator.sde_types.types", ("Score", "TraceEvent")),
    ("workflow_pipelines.run_manifest.artifacts.artifacts", ("extract_python_code",)),
    ("production_architecture.local_runtime.model_adapter.model_adapter", ("invoke_model",)),
    (
    ...
    ("guardrails_and_safety.risk_budgets_permission_matrix.time_and_budget.time_util", ("iso_now",)),
)
...
_PIPELINE_MIGRATED_PUBLIC_NAMES: Final = (
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.config",
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.report",
        ("generate_report",),
    ),
    (
    ...
    (
        "workflow_pipelines.orchestration_run_start.orchestration_run_start_contract",
        (
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.runner.organization_layer",
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.runner.success_artifacts",
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.benchmark.offline_eval_contract",
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.benchmark.production_pipeline_plan_contract",
        (
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.benchmark.suite",
        ("read_suite",),
    ),
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.run_logging",
        (
            "setup_run_logger",
            "shutdown_run_logger",
            "log_run_banner",
...
_GUARDRAILS_SUBMODULE_PUBLIC_NAMES: Final = (
    ("guardrails_and_safety.review_gating_evaluator_authority.review_gating.review", ("build_review",)),
    (
    ...
    (
        "guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.static_analysis",
    ...
    ("guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.run_profile", ("is_coding_only",)),
    ("guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.hard_stop_schedule", ("expected_hard_stop_ids",)),
    ("guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.hard_stops", ("evaluate_hard_stops",)),
    (
        "guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.hard_stops_guarded",
        ("evaluate_guarded_hard_stops",),
    ),
    (
        "guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.hard_stops_events",
    ...
    (
        "guardrails_and_safety.risk_budgets_permission_matrix.risk_budgets.hard_stops_organization",
        ("evaluate_organization_hard_stops",),
    ),
)

_EXECUTION_MODES_SUBMODULE_PUBLIC_NAMES: Final = (
    ("workflow_pipelines.strategy_overlay.execution_modes.modes.guarded", ("run_guarded",)),
    ("workflow_pipelines.strategy_overlay.execution_modes.modes.phased", ("run_phased",)),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.baseline.pipeline",
        ("run_baseline",),
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.guarded_pipeline.pipeline",
        ("run_guarded_pipeline",),
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.guarded_pipeline.verify_core",
        ("heuristic_verify", "extract_json_object", "finalize_failure_reason"),
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.phased_pipeline.pipeline",
        ("run_phased_pipeline",),
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.phased_pipeline.decompose",
...
_EXPORT_MODULES: Final = (
    ...
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.runner",
        _RUNNER_EXPORTS,
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.baseline",
        _BASELINE_MODE_EXPORTS,
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.guarded_pipeline",
        _GUARDED_PIPELINE_EXPORTS,
    ),
    (
        "workflow_pipelines.strategy_overlay.execution_modes.modes.phased_pipeline",
        _PHASED_PIPELINE_EXPORTS,
    ),
    (
        "workflow_pipelines.production_pipeline_plan_artifact.production_pipeline_task_to_promote.benchmark",
        _BENCHMARK_EXPORTS,
    ),
)
