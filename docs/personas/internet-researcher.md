...
- **Phase 11 — Recommendation gate**: formal review of “what to implement now vs monitor later” with Product/Eng leadership. **Gate**: ranked recommendations signed off. **Artifacts**: prioritized recommendation list.
