...
- [x] Create CLI entrypoint module under `src/services/orchestrator/runtime/sde/cli/`.
...
- [x] Create task suite file at `data/benchmark-tasks.jsonl`.
...
- [x] Execute `sde benchmark --suite ./data/benchmark-tasks.jsonl` in baseline mode.
- [x] Execute `sde benchmark --suite ./data/benchmark-tasks.jsonl` in guarded_pipeline mode.
