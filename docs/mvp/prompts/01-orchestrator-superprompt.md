...
1) Read and internalize:
   - docs/mvp/what.md
   - docs/mvp/how-checklist.md
   - docs/mvp/prompts/README.md
   - docs/mvp/prompts/phase-gates.md
   - docs/mvp/prompts/00-master-sequence.md

2) Run phases in order using docs/mvp/prompts/00-master-sequence.md and docs/mvp/prompts/phase-gates.md:
...
4) After each prompt and at end of each phase:
   - Update progress against docs/mvp/how-checklist.md
...
7) Completion criteria:
   - Every item in docs/mvp/how-checklist.md is completed
   - All phase gates in docs/mvp/prompts/phase-gates.md are green
